...
const FEATURES = [
  {
    ...
    text: 'Acompanhe todas as suas candidaturas em um só lugar',
  },
  { icon: TargetIcon, text: 'Organize funções e empresas com filtros rápidos' },
  { icon: UsersIcon, text: 'Mantenha seus contatos profissionais centralizados' },
];
